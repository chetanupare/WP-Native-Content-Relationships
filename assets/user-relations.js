...
jQuery(document).ready(function($) {
    ...
    $('#naticore-add-post-relation').on('click', function() {
    ...
    $('#naticore-add-user-relation').on('click', function() {
    ...
    $(document).on('click', '.naticore-search-result-item', function() {
        var $item = $(this);
        var id = $item.data('id');
    ...
    // Remove relation
    $(document).on('click', '.naticore-remove-relation', function(e) {
        e.preventDefault();
    ...
    $('#naticore-post-search, #naticore-user-search').on('keypress', function(e) {
        if (e.which === 13) {
            e.preventDefault();
