---
title: Indexing
description: Composite index for fast lookups and integrity checks. Query impact and schema stability.
---
...
The table and index layout are considered stable. Changes are versioned and documented in the [Schema](/architecture/schema). Do not add or drop indexes outside plugin upgrades.
