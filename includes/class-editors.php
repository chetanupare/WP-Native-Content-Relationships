...
class NATICORE_Editors {
	...
	public function register_gutenberg_block() {
		...
		wp_register_script(
			'naticore-gutenberg',
			NATICORE_PLUGIN_URL . 'assets/js/gutenberg.js',
...
if ( ! class_exists( 'NATICORE_Elementor_Related_Content_Tag' ) && class_exists( '\Elementor\Core\DynamicTags\Tag' ) ) {
	class NATICORE_Elementor_Related_Content_Tag extends \Elementor\Core\DynamicTags\Tag {

		public function get_name() {
			return 'naticore-related-content';
		}
