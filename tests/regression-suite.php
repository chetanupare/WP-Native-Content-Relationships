...
$reg_res = ncr_register_relation_type( array( 'name' => 'test_limit_5', 'max_connections' => 5 ) );
...
ncr_register_relation_type( array( 'name' => 'test_dir_uni', 'bidirectional' => false ) );
ncr_register_relation_type( array( 'name' => 'test_dir_bi', 'bidirectional' => true ) );
...
// Inject orphan
$wpdb->insert( $table, array( 'from_id' => 999999, 'to_id' => 1, 'type' => 'related_to', 'to_type' => 'post' ) );
...
foreach ( $indices as $index ) {
	if ( 'type_lookup' === $index->Key_name ) $found_lookup = true;
}
