...
final class NamedFunctionCallArgumentsTest extends AbstractTokenizerTestCase {
	...
	public static function dataNamedFunctionCallArguments() {
		return array(
			...
			'PHP 8.4+: named arg in exit()'                => array(
				'testMarker' => '/* testPHP84Exit */',
				'parameters' => array(
					'status',
				),
			),
			'PHP 8.4+: named arg in die()'                 => array(
				'testMarker' => '/* testPHP84Die */',
				'parameters' => array(
					'status',
				),
			),
			'PHP 8.4+: named arg in fully qualified exit()' => array(
				'testMarker' => '/* testPHP84FullyQualifiedExit */',
				'parameters' => array(
					'status',
				),
			),
			'PHP 8.4+: named arg in fully qualified die()' => array(
